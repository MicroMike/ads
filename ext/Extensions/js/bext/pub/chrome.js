...
E.impl['tpopup.trial_subscribe'] = function(args){
    if (!window.RMT || !window.RMT.be_info)
        return zerr('no RMT or be_info');
    // XXX colin: should add uninit and E.sp.spawn() so can be cancelled
    window.RMT.be_info.trial_subscribe(args[0]);
};
E.impl['tpopup.on_lang_change'] = function(args){
...
E.impl.add_listener = function(obj, sub, cb, opt, extra){
    try {
        ...
        // firefox and chrome >=71 dont support filters even undefined ones
        if (!opt)
